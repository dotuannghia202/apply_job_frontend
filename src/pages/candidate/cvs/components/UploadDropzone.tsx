...
const UploadDropzone = ({
  ...
  return (
    <Card
      className="group relative min-h-[240px] gap-0 border-2 border-dashed border-border bg-card py-0 shadow-none transition-colors duration-300 hover:border-primary"
      onDrop={handleDrop}
